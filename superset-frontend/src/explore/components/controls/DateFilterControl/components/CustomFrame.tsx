      ...
      <Row gutter={24}>
        <Col span={12}>
          <div className="control-label">
            ...
            <InfoTooltipWithTrigger
              tooltip={t('Start date of time range')} // CUSTOM
              placement="right"
            />
          </div>
          <Select
            ariaLabel={t('START')} // CUSTOM
        ...
        <Col span={12}>
          <div className="control-label">
            ...
            {t('END')}{' '}
            <InfoTooltipWithTrigger
              tooltip={t('End date of time range')} // CUSTOM
              placement="right"
            />
          </div>
          <Select
            ariaLabel={t('END')} // CUSTOM
